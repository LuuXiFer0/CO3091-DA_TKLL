...
def sign_detect(image):
    ...
    model = load_model(os.path.abspath('src/prius_sdc_pkg/prius_sdc_pkg/Detection/Signs/sign_detection_reducev3.h5'))
    ...
    if len(results) > 0:
        ...
        for i in results.flatten():
            ...
            if c_ts.shape[:1] == (0,) or c_ts.shape[1:2] == (0,):
                ...
                print(prediction, labels['SignName'][prediction])
